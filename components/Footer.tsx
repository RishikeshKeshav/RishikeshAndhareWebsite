...
const links = [
  {
    url: 'https://github.com/RishikeshKeshav',
    icon: SiGithub,
  },
  // {
  //   url: 'https://twitter.com/shubhadapaitha1',
  //   icon: SiTwitter,
  // },
  {
    url: 'mailto:rishikeshandhare1301@gmail.com',
    icon: MdMail,
  },
  {
    url: 'https://www.linkedin.com/in/rishikesh-andhare/',
    icon: SiLinkedin,
  }
];
